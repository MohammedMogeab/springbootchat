...
import com.example.websocket.client.MessageListener;
import com.example.websocket.client.MyStompSessionHandler;
...
public class MyStompClient {
    ...
    public MyStompClient(MessageListener messageListener, String username) throws ExecutionException, InterruptedException {
        ...
        String url = "ws://localhost:8081/ws"; // Use ws:// for WebSocket
